...
public class ResultSetUtils {
    ...
    public static Object getRSVal(ResultSet rs, int idx) throws SQLException {
        ...
        // ResultSet.getObject, a normal java.query.Timestamp instance is returnd.
        if (o != null && FeatureDetector.isOracleAvailable() && o.getClass().getCanonicalName().startsWith("oracle.query.TIMESTAMP")){
