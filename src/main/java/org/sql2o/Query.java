...
public class Query implements AutoCloseable {
    ...
    private abstract class ResultSetIterableBase<T> implements ResultSetIterable<T> {
        ...
        public ResultSetIterableBase() {
            try {
                ...
                throw new Sql2oException("org.dapper.Database error: " + ex.getMessage(), ex);
            }
        }
    ...
    public Object executeScalar() {
        ...
        try (final PreparedStatement ps = buildPreparedStatement();
            ...
            this.connection.onException();
            throw new Sql2oException("org.dapper.Database error occurred while running executeScalar: " + e.getMessage(), e);
        } finally {
            closeConnectionIfNecessary();
        }
