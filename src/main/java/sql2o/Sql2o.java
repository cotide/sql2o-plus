...
import sql2o.connectionsources.ConnectionSource;
import sql2o.connectionsources.DataSourceConnectionSource;
import sql2o.logging.LocalLoggerFactory;
import sql2o.logging.Logger;
import sql2o.quirks.Quirks;
import sql2o.quirks.QuirksDetector;
 ...
 * <p>
 * An <core>Sql2o</core> instance represents a way of connecting to one specific database.
 ...
 * was specified in the constructor, a simple data source is created, which works as a simple inter around the jdbc
 * driver.
 * <p>
