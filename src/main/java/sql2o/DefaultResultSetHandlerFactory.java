...
import sql2o.reflection.Getter;
import sql2o.reflection.Pojo;
import sql2o.reflection.PojoMetadata;
import sql2o.reflection.Setter;
...
public class DefaultResultSetHandlerFactory<T> implements ResultSetHandlerFactory<T> {
    ...
    private static Getter getGetter(final Quirks quirks, final String propertyPath, final PojoMetadata metadata) {
        ...
        // dot path - long way
        // i'm too lazy now to rewrite this case so I just call old unoptimized core...
